...
public class DeleteArticleService {
	...
	public void delete(DeleteArticleRequest delFlagUpdateReq) {
		...
		try {
			...
			articleDao.delete(conn, delFlagUpdateReq.getArticleNumber());
			contentDao.delete(conn, delFlagUpdateReq.getArticleNumber());
			conn.commit();
